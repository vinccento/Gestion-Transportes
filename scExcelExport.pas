...
* Description : TscExcelExport
  ...
  This TscExcelExport component is an advanced, powerful but easy to use component
  which enables you to export all records of a dataset from Borland/Codegear/Embarcadero Delphi
  to Microsoft Excel. Many features are provided to change the layout, use conditional
  formatting, to add totals, to create groups, to set a filter, ...
  This VLC component works in Delphi 5, 6, 7, 2006, 2007, 2009, 2010, XE, XE2, XE3, XE4, XE5, XE6, XE7, XE8 (32 and 64bit)
  and it supports Excel 97, 2000, XP, 2003, 2007, 2010 and 2013.

* Dates : February 2000 - June 2015
* Version : 4.26
...
* The registration cost is 35 US$ (single developer license)
  and 130 US$ (site license (unlimited developers))
* You can register yourself online on the website of Reg.Net
  https://secure.reg.net/product.asp?ID=15336 (site license)
  https://secure.reg.net/product.asp?ID=11696 (single developer license)
---------------------------------------------------------------------------------------------------------------------------------
Installation

* Open the run-time package ExcelExportPackX.dpr and build it

  Borland Delphi 5          ExcelExportPack5
  Borland Delphi 6          ExcelExportPack6
  Borland Delphi 7          ExcelExportPack7
  Borland Delphi 2005       ExcelExportPack9
  Borland Delphi 2006       ExcelExportPack10
  Codegear Delphi 2007      ExcelExportPack11
  Codegear Delphi 2009      ExcelExportPack12
  Embarcadero Delphi 2010   ExcelExportPack14
  Embarcadero Delphi XE     ExcelExportPackXE
  Embarcadero Delphi XE2    ExcelExportPackXE2
  Embarcadero Delphi XE3    ExcelExportPackXE3
  Embarcadero Delphi XE4    ExcelExportPackXE4
  Embarcadero Delphi XE5    ExcelExportPackXE5
  Embarcadero Delphi XE6    ExcelExportPackXE6
  Embarcadero Delphi XE7    ExcelExportPackXE7  
  Embarcadero Delphi XE8    ExcelExportPackXE8
  
* Open the design-time package dclExcelExportPackX.dpk and compile and install it. The install option is only available in the context popup menu.
* The TscExcelExport component can be found in the tabsheet 'SC' of the component palette.
* When you like to add the component to an existing package, add the unit scExcelExport to a run-time package. 
  Make sure the DCP file dclOffice is added as required. This file can be found in the Delphi Lib folder. 
...
* The Turbo Delphi (Win32) Explorer edition does not support installing custom components in design time. 
  So the ExcelExportPack10 package cannot be installed. The TscExcelExport component should be created in runtime to use it.
* Make sure to add a path to the folder with the scExcelExport.pas file in the global Library path 
  of Delphi (Tools >> Options >> Delphi Options >> Library) before compiling the demo project.

Live templates

* The 2 live templates (ExcelExportCreate.xml and ExcelExportUse.xml) should be copied to
  Delphi 2006   C:\Program Files\Borland\BDS\4.0\Objrepos\code_templates\delphi
  Delphi 2007   C:\Program Files\CodeGear\RAD Studio\5.0\ObjRepos\Code_Templates\Delphi
  Delphi 2009   C:\Program Files\CodeGear\RAD Studio\6.0\ObjRepos\Code_Templates\Delphi
  Delphi 2010   C:\Program Files\Embarcadero\RAD Studio\7.0\ObjRepos\Code_Templates\Delphi
  Delphi XE     C:\Program Files\Embarcadero\RAD Studio\8.0\ObjRepos\en\Code_Templates\Delphi
  Delphi XE2    C:\Program Files\Embarcadero\RAD Studio\9.0\ObjRepos\en\Code_Templates\Delphi
  Delphi XE3    C:\Program Files\Embarcadero\RAD Studio\10.0\ObjRepos\en\Code_Templates\Delphi
  Delphi XE4    C:\Program Files\Embarcadero\RAD Studio\11.0\ObjRepos\en\Code_Templates\Delphi
  Delphi XE5    C:\Program Files\Embarcadero\RAD Studio\13.0\ObjRepos\en\Code_Templates\Delphi
  Delphi XE6    C:\Program Files\Embarcadero\RAD Studio\14.0\ObjRepos\en\Code_Templates\Delphi
  Delphi XE7    C:\Program Files\Embarcadero\RAD Studio\15.0\ObjRepos\en\Code_Templates\Delphi
  Delphi XE8    C:\Program Files\Embarcadero\RAD Studio\16.0\ObjRepos\en\Code_Templates\Delphi
---------------------------------------------------------------------------------------------------------------------------------
Type library

* There are several versions of Excel type libraries which can be used.
* Use scExcelExportConfig.inc to set one of the compiler directives.
* Excel 2000 is de default type library for compatibility reasons with previous versions of the TscExcelExport component
* When using the TscExcelExport component for the first time, it is better to use the ExcelXP type library
  because this is a more recent version
* Delphi XE2 also contains the new Excel 2010 library. It will be the default but you have to change 
  it if you would like to support older Excel versions.
* Make sure to install update 1 and 2 of Delphi XE2 if you would like to use this component.

* EXCEL2010    Excel2010.pas       package DclOffice2010
* EXCELXP      ExcelXP.pas         package DclOfficeXP
* EXCEL2000    Excel2000.pas       package DclOffice2k, package DclOffice2k50
* EXCEL97      Excel97.pas

Delphi         |  XE8  | XE7  |  XE6  |  XE5  |  XE4  |   XE3 |   XE2 |   XE  |  2010 |  2009 |  2007 | Turbo |  2006 |  2005 |   7   |   6   | 5 SP1 |   5   |
----------------------------------------------------------------------------------------------------------------------------------------------------------------
Excel2010.pas  |   x   |   x   |   x   |   x   |   x   |   x   |   x   |       |       |       |       |       |       |       |       |       |       |       |
----------------------------------------------------------------------------------------------------------------------------------------------------------------
ExcelXP.pas    |   x   |   x   |   x   |   x   |   x   |   x   |   x   |   x   |   x   |   x   |   x   |   x   |   x   |   x   |   x   |       |       |       |
----------------------------------------------------------------------------------------------------------------------------------------------------------------
Excel2000.pas  |       |       |       |       |       |       |   x   |   x   |   x   |   x   |   x   |   x   |   x   |   x   |   x   |   x   |       |       |
----------------------------------------------------------------------------------------------------------------------------------------------------------------
Excel97.pas    |       |       |       |       |       |       |       |       |       |       |       |       |       |   x   |   x   |   x   |   x   |       |
----------------------------------------------------------------------------------------------------------------------------------------------------------------

* The pas files can be found in
  Delphi 7      C:\Program Files\Borland\Delphi7\OCX\Servers
  Delphi 2005   C:\Program Files\Borland\BDS\3.0\OCX\Servers
  Delphi 2006   C:\Program Files\Borland\BDS\4.0\OCX\Servers
  Delphi 2007   C:\Program Files\CodeGear\RAD Studio\5.0\OCX\Servers
  Delphi 2009   C:\Program Files\CodeGear\RAD Studio\6.0\OCX\Servers
  Delphi 2010   C:\Program Files\Embarcadero\RAD Studio\7.0\OCX\Servers
  Delphi XE     C:\Program Files\Embarcadero\RAD Studio\8.0\OCX\Servers
  Delphi XE2    C:\Program Files\Embarcadero\RAD Studio\9.0\OCX\Servers\pas2010
  Delphi XE3    C:\Program Files\Embarcadero\RAD Studio\10.0\OCX\Servers\pas2010
  Delphi XE4    C:\Program Files\Embarcadero\RAD Studio\11.0\OCX\Servers\pas2010
  Delphi XE5    C:\Program Files\Embarcadero\RAD Studio\13.0\OCX\Servers\pas2010
  Delphi XE6    C:\Program Files\Embarcadero\RAD Studio\14.0\OCX\Servers\pas2010
  Delphi XE7    C:\Program Files\Embarcadero\RAD Studio\15.0\OCX\Servers\pas2010
  Delphi XE8    C:\Program Files\Embarcadero\RAD Studio\16.0\OCX\Servers\pas2010
  
* The installed version of MS Office should be the same or more recent as the version of the Delphi unit.

MS Excel       |  2013 |  2010 |  2007 |  2003 |   XP  |  2000 |   97  |
------------------------------------------------------------------------
Excel2010.pas  |   x   |   x   |       |       |       |       |       |
------------------------------------------------------------------------
...
* The warnings 'unsafe code', 'unsafe type' and 'unsafe typecast' should be ignored
  when compiling the ExcelExport packages. In Delphi 7, 2005, 2006, Turbo Delphi,
  2007, 2009, 2010, XE, XE2, XE3, XE4, XE5, XE6 and XE7 these warnings can be disabled in your project options.
* EOleSysError "Class not registered" exception. This error occurs when one or more DLL's
  from Microsoft are not registered in Windows. You could register them with the
  regsvr.exe tool which can be found in Windows\System32 folder.
  The problem is that the EOleSysError does not specify which DLL's are causing the problem.
  So the best solution is to reinstall Office/Excel.
* Error reading ExplicitTop, ExplicitLeft, ExplicitWidth and ExplicitHeight properties when
  opening the demo application in other Delphi versions than 2007/2009/2010/XE/XE2/XE3/XE4/XE5/XE6/XE7/XE8.
  Just choose "Ignore all". These properties will be removed from the DFM and
  the application will run fine in Delphi 6, 7, 2006, 2009, 2010, XE, XE2, XE3, XE4, XE5, XE6, XE7, XE8...
---------------------------------------------------------------------------------------------------------------------------------
Version history
...
Version 3.7 (February 2008)
  - Added ftWideMemo datatype in IsMemoField function (>= Delphi 2006)
  - Added ftFixedWideChar, ftWideMemo, ftOraTimeStamp and ftOraInterval datatype
    to CanConvertFieldToCell function (>= Delphi 2006)
  - Added internal record with Excel restrictions (max rows, max columns, max string length)
    which will be initialized after checking the Excel type library and version
  - Added EMaxColumnsReached and EMaxRowsReached exceptions and resource strings
  - Added support for more than 256 columns in Excel 2007 (thanks to Stuart Clennett)
  - Bugfix when exporting strings larger than 910 characters in Excel 2003 (thanks to Arnd Iffland)
Version 3.8 (October 2008)
  ...
  - Important modifications and bugfixes for exporting dates and times. Now these values are always
    exported as Delphi datetime (=float) which is the same as the internal Excel
    datetime value (1 = 1 january 1900). Formatting is done afterwards in the SetFormat function.
    This should solve all date problems in international Excel versions.
  - Added support for Delphi 2009
  - Bugfix when setting border and font when using OnGetStyle events (thanks to Arnd Iffland)
Version 3.81 (November 2008)
  - Support for Interbase TSQLTimeStampField
Version 3.9 (October 2009)
  - Added support for Delphi 2009
Version 4.0 (April 2011)
  - Added support for Delphi 2010 and XE 
  - Added support for Office 2010
  - Support for ftSingle field type
  - Bugfix SetFormat when there are invisible fields (thanks to Jose Desco)
  - Added COUNT as summary calculation (thanks to Jurandi Nunes)
  - Added BackAlternateColor to CellBorder (thanks to Perry Schwartz)
Version 4.1 (December 2011)
  - Added support for Delphi XE2 (thanks to Jürg Krieg). Installing update 1 and 2 of Delphi XE2 is required
  - Added support for Excel2010 type library
  - Bugfix exporting as XLSX in Office 2010
Version 4.2 (October 2012)
  - Added support for Delphi XE3
Version 4.21 (December 2012)
  - Bugfix for Delphi XE3
...
type
  ...
  /// <Summary>
  /// Exception : The maximum number of columns has been reached
  /// Excel 2010/2007 (only .XLSX) = 16384 (2^14)
  /// Excel 2007/2003/XP/2000/97 (.XLS) = 256 (2^8)
  /// </Summary>
  EMaxColumnsReached = class(Exception);
  /// <Summary>
  /// Exception : The maximum number of rows has been reached
  /// Excel 2010/2007 (only .XLSX) = 1048576 (2^20)
  /// Excel 2010/2007/2003/XP/2000/97 (.XLS) = 65536 (2^16)
  /// </Summary>
  EMaxRowsReached = class(Exception);
  ...
  TTypeLibrary = (
    ...
    tlExcelXP,
    /// <Summary>
    /// Compiler directive : EXCEL2010
    /// File : Excel2010.pas
    /// Package : DclOffice2010
    /// </Summary>
    tlExcel2010);	
  ...
  /// </Summary>
  TSummaryCalculation = (scSUM, scMIN, scMAX, scAVG, scCOUNT);
  ...
  /// Row type
  /// </Summary>
  TRowType = (rtHeader, rtFooter, rtTitles, rtData, rtGroup, rtSummary);
  ...
  published
    ...
    /// <Summary>
    /// Background color of alternate row cells
    /// </Summary>
    property BackAlternateColor : TColor read FBackAlternateColor write FBackAlternateColor default clWhite;
    /// <Summary>
  ...
  /// <Summary>
  /// Restrictions of current Excel (depending type library and version)
  /// Rows : Excel 2010/2007 (only .XLSX) = 16384 (2^14)
  /// Rows : Excel 2010/2007/2003/XP/2000/97 (.XLS) = 256 (2^8)
  /// Columns : Excel 2010/2007 (only .XLSX) = 1048576 (2^20)
  /// Columns : Excel 2010/2007/2003/XP/2000/97 (.XLS) = 65536 (2^16)
  /// Cell : Excel 2000/2007/2010 : 99999
  /// Cell : Excel 97/XP/2003 : 910
  /// </Summary>
  RecExcelRestrictions = record
  ...
  private
    ...
    FRecExcelRestrictions : RecExcelRestrictions;
  protected
    ...
    function IsDateTimeField(const IntFieldIndex: Integer) : Boolean;
  ...
  public
    ...
    /// <Summary>
    /// Which type library is being used ? (Excel97, Excel2000, ExcelXP, Excel2010)
    /// </Summary>
    property TypeLibrary : TTypeLibrary read fTypeLibrary;

    /// <Summary>
    /// Excel version 8=97 9=2000 10=2002, 11=2003, 12=2007, 14=2010, 15=2013, 16:2015
    /// </Summary>
    ...
    /// Maximum length of cell text
    /// </Summary>
    /// </Summary>
    property ExcelRestrictions : RecExcelRestrictions read FRecExcelRestrictions;
    ...
    /// <Returns>
    /// </Returns>
    procedure SetFontAndBorderRange(RowType : TRowType; DelphiFont : TxlFont; Border : TCellBorder; StrBeginCell, StrEndCell : String);
    /// <Summary>
    ...
    /// <Summary>
    /// Get Excel format for given Delphi currency format
    /// </Summary>
    ...
    /// <Summary>
    /// Get Excel format for given Delphi datetime format
    /// </Summary>
    /// <Param name="StrFormat">
    /// </Param>
    /// <Returns>
  ...
  published
    ...
    /// <Summary>
    /// Calculation : SUM, MIN, MAX, AVG, COUNT
    /// </Summary>
...
resourcestring
  ...
  rsMaxRowsReached = 'The maximum number of rows (%d) has been reached';
  rsMaxColumnsReached = 'The maximum number of columns (%d) has been reached';
...
begin
  ...
  begin
    ...
    FBorderData.FBackAlternateColor := clWhite;
...
//------------------------------------------------------------------------------
procedure TscExcelExport.SetFontAndBorderRange(RowType : TRowType; DelphiFont : TxlFont; Border : TCellBorder; StrBeginCell, StrEndCell : String);
var
  intRow : integer;
...
begin
  ...
  // Set alternate row colors using FBackAlternateColor
  if (RowType = rtData) and (BorderData.FBackAlternateColor <> clWhite) then
  begin
    IntBeginRow := FIntBeginRowData;
    IntEndRow := FIntEndRowData;
    if (IntBeginRow<=IntEndRow) and (strBeginCell = GetColumnCharacters(FIntBeginColumnData)+intToStr(intBeginRow)) then
    begin
      for intRow := IntBeginRow to IntEndRow do
      begin
         if (intRow mod 2 = 0) and (BorderData.FBackColor <> BorderData.FBackAlternateColor)
           or (BorderData.FBackColor = BorderData.FBackAlternateColor )then
          begin
             FExcelWorksheet.Range[GetColumnCharacters(FIntBeginColumnData)+intToStr(intRow),
               GetColumnCharacters(FSLFieldNames.Count + FIntBeginColumnData - 1)+intToStr(intRow)].Interior.Color := BorderData.FBackColor;
          end
          else
          begin
            FExcelWorksheet.Range[GetColumnCharacters(FIntBeginColumnData)+intToStr(intRow),
              GetColumnCharacters(FSLFieldNames.Count + FIntBeginColumnData - 1)+intToStr(intRow)].Interior.Color := BorderData.FBackAlternateColor;
          end;
        end;
    end;
  end
...
{$WARNINGS OFF}
  ...
  {$IFDEF DELPHIXEORNEWER}
    FDecimalSeparator   := GetLocaleChar(DefaultLCID, LOCALE_SDECIMAL, FormatSettings.DecimalSeparator);
    FThousandSeparator  := GetLocaleChar(DefaultLCID, LOCALE_STHOUSAND, FormatSettings.ThousandSeparator);
  {$ELSE}  
...
//------------------------------------------------------------------------------
procedure TscExcelExport.InitRestrictions;
begin
  FRecExcelRestrictions.MaxNumberOfRows := 65536;
  FRecExcelRestrictions.MaxNumberOfColumns := 256;
  FRecExcelRestrictions.MaxStringLength := 910;

  // 8=97 9=2000 10=2002, 11=2003, 12=2007, 14=2010, 15=2013, 16=2015
  if FIntExcelVersion >= 12 then
  begin
    FRecExcelRestrictions.MaxNumberOfRows := 1048576;
    FRecExcelRestrictions.MaxNumberOfColumns := 16384;
    FRecExcelRestrictions.MaxStringLength := 99999;
  end;
...
//------------------------------------------------------------------------------
function TscExcelExport.GetCurrencyFormat(StrFormat : String) : String;
begin
  ...
  case FormatSettings.CurrencyFormat of
    0 : Result := FormatSettings.CurrencyString+StrFormat;
    1 : Result := StrFormat+FormatSettings.CurrencyString;
    2 : Result := FormatSettings.CurrencyString+' '+StrFormat;
    3 : Result := StrFormat+' '+FormatSettings.CurrencyString;
  end;
  {$ELSE}
...
//------------------------------------------------------------------------------
function TscExcelExport.GetDateTimeFormat(StrFormat : String) : String;
begin
  // Depending regional settings of Excel, change the displayformat
  // of Delphi to the one of Excel
  StrFormat := StringReplace(StrFormat,'h',FExcelApplication.Application.International[xlHourCode,fLCID],[rfReplaceAll]);
  StrFormat := StringReplace(StrFormat,'n',FExcelApplication.Application.International[xlMinuteCode,fLCID],[rfReplaceAll]);
  StrFormat := StringReplace(StrFormat,'s',FExcelApplication.Application.International[xlSecondCode,fLCID],[rfReplaceAll]);
  {$IFDEF DELPHIXEORNEWER}
  StrFormat := StringReplace(StrFormat,FormatSettings.DateSeparator,FExcelApplication.Application.International[xlDateSeparator,fLCID],[rfReplaceAll]);
  StrFormat := StringReplace(StrFormat,FormatSettings.TimeSeparator,FExcelApplication.Application.International[xlTimeSeparator,fLCID],[rfReplaceAll]);
  {$ELSE}
  StrFormat := StringReplace(StrFormat,DateSeparator,FExcelApplication.Application.International[xlDateSeparator,fLCID],[rfReplaceAll]);
  StrFormat := StringReplace(StrFormat,TimeSeparator,FExcelApplication.Application.International[xlTimeSeparator,fLCID],[rfReplaceAll]);
  {$ENDIF}
  StrFormat := StringReplace(StrFormat,'y',FExcelApplication.Application.International[xlYearCode,fLCID],[rfReplaceAll]);
  StrFormat := StringReplace(StrFormat,'m',FExcelApplication.Application.International[xlMonthCode,fLCID],[rfReplaceAll]);
  StrFormat := StringReplace(StrFormat,'d',FExcelApplication.Application.International[xlDayCode,fLCID],[rfReplaceAll]);
  StrFormat := StringReplace(StrFormat,'AMPM','AM/PM',[rfReplaceAll]);
  Result := StrFormat;
end;
...
begin
  ...
  begin
    ...
    FieldType := GetFieldDataType(Integer(FSLFieldNames.Objects[IntColumn-1]));
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            begin
              try
                ...
                if FieldType in [ftFloat, ftCurrency,
                  {$IFDEF DELPHI2010ORNEWER} ftSingle, {$ENDIF} 
                  {$IFNDEF DELPHI5} ftFMTBcd, {$ENDIF}
                  ftBCD] then
            ...
            begin
              ...
              begin
                {$IFDEF DELPHIXEORNEWER}
                FExcelWorksheet.Range[StrBeginCell,StrEndCell].NumberFormat :=
                  GetCurrencyFormat(SetNumberSeparator('#,##0.'+StringOfChar('0', FormatSettings.CurrencyDecimals)));
                {$ELSE}
                FExcelWorksheet.Range[StrBeginCell,StrEndCell].NumberFormat :=
          ...
          begin
            if FieldByName(FSLFieldNames[IntColumn-1]) is TDateField then
            begin
              if TDateField(FieldByName(FSLFieldNames[IntColumn-1])).DisplayFormat <> '' then
              begin
                FExcelWorksheet.Range[StrBeginCell,StrEndCell].NumberFormat :=
                  GetDateTimeFormat(TDateField(FieldByName(FSLFieldNames[IntColumn-1])).DisplayFormat);
              end
              else
              begin
                {$IFDEF DELPHIXEORNEWER}
                FExcelWorksheet.Range[StrBeginCell,StrEndCell].NumberFormat :=
                   GetDateTimeFormat(FormatSettings.ShortDateFormat);
                {$ELSE}
                FExcelWorksheet.Range[StrBeginCell,StrEndCell].NumberFormat :=
                   GetDateTimeFormat(ShortDateFormat);
                {$ENDIF}
              end;
            end
            else
            begin
              if FieldByName(FSLFieldNames[IntColumn-1]) is TTimeField then
              begin
                if TTimeField(FieldByName(FSLFieldNames[IntColumn-1])).DisplayFormat <> '' then
                begin
                  FExcelWorksheet.Range[StrBeginCell,StrEndCell].NumberFormat :=
                    GetDateTimeFormat(TDateField(FieldByName(FSLFieldNames[IntColumn-1])).DisplayFormat);
                end
                ...
                begin
                  {$IFDEF DELPHIXEORNEWER}
                  FExcelWorksheet.Range[StrBeginCell,StrEndCell].NumberFormat :=
                     GetDateTimeFormat(FormatSettings.ShortTimeFormat);
                  {$ELSE}
                  FExcelWorksheet.Range[StrBeginCell,StrEndCell].NumberFormat :=
                     GetDateTimeFormat(ShortTimeFormat);
                  {$ENDIF}
                end;
              end
              else
              begin
                ...
                begin
                  ...
                  begin
                    {$IFDEF DELPHIXEORNEWER}
                     FExcelWorksheet.Range[StrBeginCell,StrEndCell].NumberFormat :=
                       GetDateTimeFormat(FormatSettings.ShortDateFormat + ' ' + FormatSettings.ShortTimeFormat);
                    {$ELSE}
                     FExcelWorksheet.Range[StrBeginCell,StrEndCell].NumberFormat :=
                       GetDateTimeFormat(ShortDateFormat + ' ' + ShortTimeFormat);
                    {$ENDIF}
                  end;
                end
                else
                begin
                  {$IFNDEF DELPHI5}
				  if FieldByName(FSLFieldNames[IntColumn-1]) is TSQLTimeStampField then
                  begin
                    if TSQLTimeStampField(FieldByName(FSLFieldNames[IntColumn-1])).DisplayFormat <> '' then
                    begin
                      FExcelWorksheet.Range[StrBeginCell,StrEndCell].NumberFormat :=
                        GetDateTimeFormat(TSQLTimeStampField(FieldByName(FSLFieldNames[IntColumn-1])).DisplayFormat);
                    end
                    else
                    begin
                      {$IFDEF DELPHIXEORNEWER}
    ...
    begin
      ...
      if FieldType in [ftSmallint, ftInteger, ftWord, ftBoolean,
        {$IFDEF DELPHI2010ORNEWER} ftLongWord, ftShortint, {$ENDIF} 
        ftLargeInt] then
        FExcelWorksheet.Range[StrBeginCell,StrEndCell].NumberFormat := '0'
      else
      {$IFDEF DELPHIXEORNEWER}
      if FieldType = ftString then
        ...
        FExcelWorksheet.Range[StrBeginCell,StrEndCell].NumberFormat := GetDateTimeFormat(FormatSettings.ShortDateFormat)
      else if FieldType = ftTime then
        FExcelWorksheet.Range[StrBeginCell,StrEndCell].NumberFormat := GetDateTimeFormat(FormatSettings.ShortTimeFormat)
      else if FieldType = ftDateTime then
        FExcelWorksheet.Range[StrBeginCell,StrEndCell].NumberFormat := GetDateTimeFormat(FormatSettings.ShortDateFormat + ' ' + FormatSettings.ShortTimeFormat)
      {$ELSE}
      if FieldType = ftString then
        FExcelWorksheet.Range[StrBeginCell,StrEndCell].NumberFormat := '@'
      else if FieldType = ftDate then
        FExcelWorksheet.Range[StrBeginCell,StrEndCell].NumberFormat := GetDateTimeFormat(ShortDateFormat)
      else if FieldType = ftTime then
        FExcelWorksheet.Range[StrBeginCell,StrEndCell].NumberFormat := GetDateTimeFormat(ShortTimeFormat)
      else if FieldType = ftDateTime then
        FExcelWorksheet.Range[StrBeginCell,StrEndCell].NumberFormat := GetDateTimeFormat(ShortDateFormat + ' ' + ShortTimeFormat)
      {$ENDIF}
      {$IFNDEF DELPHI5}
...
begin
  Result := FieldDataType[IntFieldIndex] in
    ...
    {$IFDEF DELPHI2006ORNEWER} ftFixedWideChar, {$ENDIF}
    {$IFDEF DELPHI2006ORNEWER} ftWideMemo, {$ENDIF}
    {$IFDEF DELPHI2006ORNEWER} ftOraTimeStamp, {$ENDIF}
    {$IFDEF DELPHI2006ORNEWER} ftOraInterval, {$ENDIF}
    {$IFDEF DELPHI2010ORNEWER} ftLongWord, {$ENDIF}
    {$IFDEF DELPHI2010ORNEWER} ftShortint, {$ENDIF}
    {$IFDEF DELPHI2010ORNEWER} ftSingle, {$ENDIF}
    ftString, ftSmallint, ftInteger, ftWord, ftAutoInc,
    ftBoolean, ftFloat, ftCurrency, ftBCD,
    ftDate, ftTime, ftDateTime, ftLargeInt, ftWideString,
    ftVariant, ftMemo, ftOraClob, ftFmtMemo
    ];
end;
...
begin
  Result := FieldDataType[IntFieldIndex] in
    [{$IFNDEF DELPHI5} ftFMTBcd, {$ENDIF}
    {$IFDEF DELPHI2010ORNEWER} ftSingle, ftLongWord, ftShortint, {$ENDIF}
    ftSmallint, ftInteger, ftWord, ftFloat, ftCurrency, ftBCD];
end;

//------------------------------------------------------------------------------
function TscExcelExport.IsDateTimeField(const IntFieldIndex: Integer) : Boolean;
begin
  Result := FieldDataType[IntFieldIndex] in
    [
    {$IFNDEF DELPHI5} ftTimeStamp, {$ENDIF}
...
//------------------------------------------------------------------------------
// Excel 2007 XLSX        | 1048576 (2^20) |  16384 (2^14) |
// Excel 2007/2003/XP XLS |   65536 (2^16) |     256 (2^8) |
//------------------------------------------------------------------------------
function TscExcelExport.GetColumnCharacters(IntNumber : Integer) : String;
begin
  if IntNumber > FRecExcelRestrictions.MaxNumberOfColumns then
  begin
    raise EMaxColumnsReached.Create(Format(rsMaxColumnsReached,[FRecExcelRestrictions.MaxNumberOfColumns]));
    IntNumber := FRecExcelRestrictions.MaxNumberOfColumns;
  end;

  Result := '';

  while (IntNumber > 0) do
  begin
    Result := Chr(((IntNumber - 1) mod 26) + 65 ) + Result;
    IntNumber := (IntNumber-1) div 26;
  end;
end;
...
begin
  ...
  try
    ...
    if Regist.OpenKey('\Software\Microsoft\Office\16.0\Excel',false) then
      Result := 16 //2015
    else if Regist.OpenKey('\Software\Microsoft\Office\15.0\Excel',false) then
      Result := 15 //2013
    else if Regist.OpenKey('\Software\Microsoft\Office\14.0\Excel',false) then
      Result := 14 //2010
    else if Regist.OpenKey('\Software\Microsoft\Office\12.0\Excel',false) then
      Result := 12 //2007
  ...
  try
    ...
    begin
      ...
      begin
        ...
        SetFontAndBorderRange(rtHeader, FFontHeader, FBorderHeader,
          StrBeginColumnChar + IntToStr(FIntBeginRowHeader+i-1),
          StrBeginColumnChar + IntToStr(FIntBeginRowHeader+i-1));
       end;
    end
  ...
  try
    ...
    begin
      ...
      begin
        ...
        SetFontAndBorderRange(rtFooter, FFontFooter, FBorderFooter,
          StrBeginColumnChar + IntToStr(FIntBeginFooter+i-1),
          StrBeginColumnChar + IntToStr(FIntBeginFooter+i-1));
       end;
    end
...
begin
  ...
  begin
    ...
    SetFontAndBorderRange(rtTitles, FFontTitles, FBorderTitles, FStrBeginColumnDataChar+IntToStr(FIntBeginRowTitles),
...
begin
  ...
  try
    ...
    begin
      ...
      if IntMatrixRow > FRecExcelRestrictions.MaxNumberOfRows then
      begin
        raise EMaxRowsReached.Create(Format(rsMaxRowsReached,[FRecExcelRestrictions.MaxNumberOfRows]));
        Exit;
      end;
      ...
      begin
        ...
        begin
          ...
          begin
            if Length(DataSet.Fields[Integer(FSLFieldNames.Objects[IntColumn - 1])].AsString) < FRecExcelRestrictions.MaxStringLength then
              VarCurrentValue := DataSet.Fields[Integer(FSLFieldNames.Objects[IntColumn - 1])].AsVariant
            else
              VarCurrentValue := Copy(DataSet.Fields[Integer(FSLFieldNames.Objects[IntColumn - 1])].AsString,1,(FRecExcelRestrictions.MaxStringLength-3))+'...';
          end
          else
          begin
            ...
            begin
              if (IsDateTimeField(Integer(FSLFieldNames.Objects[IntColumn - 1]))) then
              begin
                ...
                begin
                  VarCurrentValue := DataSet.Fields[Integer(FSLFieldNames.Objects[IntColumn - 1])].AsDateTime;
                end;
              end
              else
                if Length(DataSet.Fields[Integer(FSLFieldNames.Objects[IntColumn - 1])].AsString) < FRecExcelRestrictions.MaxStringLength then
      ...
      begin
        ...
        begin
          ...
          SetFontAndBorderRange(rtData, FFontData, FBorderData,FStrBeginColumnDataChar+IntToStr(IntBeginRow),
            GetColumnCharacters(FSLFieldNames.Count + FIntBeginColumnData -1)+IntToStr(IntEndRow));
  ...
  if (not IsColorEventAssigned) and (FIntEndRowData > FIntBeginRowData) then
    SetFontAndBorderRange(rtData, FFontData, FBorderData,FStrBeginColumnDataChar+IntToStr(FIntBeginRowData),
...
const
  SUM_ARR : array[TSummaryCalculation] of String = ('SUM', 'MIN', 'MAX', 'AVERAGE', 'COUNT');
var
  IntColumn : Integer;
  StrCell : String;
  StrCalc : String;
...
begin
  ...
  SetFontAndBorderRange(rtSummary, FFontSummary, FBorderSummary, 'A'+IntToStr(FIntRecordNo + FIntBeginRowData),
        ...
        begin
          ...
          try
            ...
            begin
              ...
              SetFontAndBorderRange(rtGroup, FFontGroup,FBorderGroup,StrHeaderCell,StrHeaderCell);
            end
            else
            begin
              ...
              SetFontAndBorderRange(rtGroup, FFontGroup,FBorderGroup,StrHeaderCell,StrHeaderEndCell);
            end;
          except
          end;
        end;
...
var
  IntBeginRow : Integer;
begin
  if FBlnShowTitles and FBlnAutoFilter then
  begin
    IntBeginRow := FExcelWorksheet.UsedRange[LCID].Row;
    FExcelWorksheet.UsedRange[LCID].Offset[FIntBeginRowTitles-IntBeginRow, FIntBeginColumnData-1]
      .AutoFilter(1,EmptyParam,xlAnd,EmptyParam,True);
  end;
end;
...
begin
  ...
  case FileFormat
   of
    ...
    //  2000/XP/2003 -> XLS
    //  2007/2010/2013/2015 -> XLSX (Open XML)
    ffDefault : FExcelWorksheet.SaveAs(StrFileName);
    // Excel 2007 Open XML format (file extension XLSX)
    ffXLSX :
      begin
        if FIntExcelVersion >= 12 then
